...
void loadTex(const vector<string> &texNames, vector<vector<Point>> &vertexes, vector<Point2f> &ratio, unsigned int *tex, bool detectEdge = true, float sizeRate = 1.0f)
{
    ...
    for (int i = 0; i < texNames.size(); i++)
    {
        ...
        resize(a, a, Size(0, 0), sizeRate, sizeRate);
...
void loadTex(void)
{
    ...
    texNames = vector<string>({"../img/witch1.png", "../img/witch2.png", "../img/witch3.png", "../img/monitor.png", "../img/butai.png", "../img/butai_fellow.png", "../img/monitor.png"});
    ...
    loadTex(texNames, kyokoVertex, kyokoRatio, kyokoTex, false, 0.25);
    ...
    loadTex(texNames, madokaVertex, madokaRatio, madokaTex, false, 0.25);
    ...
    loadTex(texNames, sayakaVertex, sayakaRatio, sayakaTex, false, 0.25);
}
