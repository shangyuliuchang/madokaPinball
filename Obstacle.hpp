...
public:
    ...
    Obstacle(const vector<Point2f> &_points, unsigned int _tex, float ratioX = 1.0f, float ratioY = 1.0f, float angle = 0.0f);
    ...
    static Obstacle texObs(float x, float y, int n, float _len = 10.0f, float angle = 0.0f);
